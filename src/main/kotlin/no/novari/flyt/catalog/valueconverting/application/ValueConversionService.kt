...
import no.novari.flyt.catalog.valueconverting.api.dto.ValueConversionResponse
...
import no.novari.flyt.catalog.valueconverting.domain.ValueConversionMapper
import no.novari.flyt.catalog.valueconverting.infrastructure.persistence.ValueConversionRepository
import no.novari.flyt.catalog.valueconverting.infrastructure.persistence.ValueConversionSpecifications
...
class ValueConversionService(
    ...
    @Transactional("valueConvertingTransactionManager")
    fun update(
